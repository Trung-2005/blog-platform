...
---+-----------+------------       1. Viet
 1 | Viet      |     1             2. Eng
 2 | Eng       |     2             3. Translations
 3 | Trans...  |     3
```

Nếu bạn muốn đưa "Eng" lên trước "Viet", chỉ cần đổi `sort_order`:
```sql
UPDATE categories SET sort_order = 1 WHERE name = 'Eng';
UPDATE categories SET sort_order = 2 WHERE name = 'Viet';
```
...
id | name      | slug
---+-----------+-------------
 5 | Nhật Ký   | viet/nhat-ky
 6 | Truyện    | viet/truyen
 8 | Journal   | eng/journal
```
...
```
📅 18 April 2017  ·  👁️ 1,234 lượt xem  ·  📂 Nhật Ký
```
...
**Dùng để làm gì?**
- Hiển thị "Published April 27, 2026" trên bài — lấy từ `published_at`, không phải `created_at`
...
- Tìm tất cả bài có tag "Dylan Thomas" → ra cả bài tiếng Việt lẫn bài dịch
